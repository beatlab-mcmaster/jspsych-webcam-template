var jsPsychVirtualChinrest = (function(jspsych) {
    ...
    const info = {
        ...
        parameters: {
          ...
          <p> We will first perform some device calibration to estimate your screen parameters and viewing distance.</p>
          ...
          <p>It is critically important that you actually get out a real credit or ID card. This is how we know how big to present images on your screen.</p> 
          <p>If you do not have access to a real card you can use a ruler to measure the image width to 3.37 inches or 85.6 mm.</p>
            ...
            redo_trials: {
                type: jspsych.ParameterType.INT,
                pretty_name: "Number of repetitions to perform when re-doing the task",
                default: 1,
            },
            ...
            viewing_distance_report: {
                ...
                default: `<p>Based on your responses, you are sitting about <span id='distance-estimate' style='font-weight: bold;'> </span> from the screen. <br>
                <span id='adjust-instruction'></span></p>`,
            },
     ...
     * @editedBy Shreshth Saxena & Jackson Shi
     */
      ...
      `;
            ...
            const showReport = () => {
                ...
                if (calc_dist_cm >= 46.5 && calc_dist_cm <= 53.5) {
                    ...
                    //Redo trials to estimate distance again 
                    display_element.querySelector("#proceed").style.visibility = 'hidden';
                    if (calc_dist_cm < 46.5) {
                        display_element.querySelector("#adjust-instruction").innerHTML = `Please move farther back such that your distance from the screen is about 50 cm and redo the task.`;
                    } else if (calc_dist_cm > 53.5) {
                        display_element.querySelector("#adjust-instruction").innerHTML = `Please move closer such that your distance from the screen is about 50 cm and redo the task.`;
                    }
                    this.reps_remaining = trial.redo_trials;
                    display_element
