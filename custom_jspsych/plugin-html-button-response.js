var jsPsychHtmlButtonResponse = (function(jspsych) {
    ...
    class HtmlButtonResponsePlugin {
        ...
        trial(display_element, trial) {
            // display stimulus
            let html = '<div class="virtual-window-form" id="jspsych-html-button-response-stimulus">' + trial.stimulus;
            //display buttons
            let buttons = [];
            ...
            for (let i = 0; i < trial.choices.length; i++) {
                ...
                html +=
                    '<div class="form-btn" style="border: none;" id="jspsych-html-button-response-button-' +
                    i +
                    '" data-choice="' +
                    i +
                    '">' +
            ...
            function after_response(choice) {
                ...
                let btns = document.querySelectorAll(".jspsych-html-button-response-button");
